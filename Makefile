build:
	javac -classpath lib/zookeeper-3.3.2.jar:lib/log4j-1.2.15.jar ZkConnector.java ClientDriver.java JobTracker.java FileServer.java Worker.java JobTrackerHandlerThread.java JobPacket.java DictionaryPacket.java
runClientDriver:
